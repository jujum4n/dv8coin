#############################################################################
# Makefile for building: dv8coin-qt
# Generated by qmake (2.01a) (Qt 4.8.4) on: Tue Apr 1 18:55:36 2014
# Project:  dv8coin-qt.pro
# Template: app
# Command: c:\Qt\4.8.4\bin\qmake.exe USE_UPNP=- -o Makefile dv8coin-qt.pro
#############################################################################
...
Makefile: dv8coin-qt.pro  c:/Qt/4.8.4/mkspecs/win32-g++/qmake.conf c:/Qt/4.8.4/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_UPNP=- -o Makefile dv8coin-qt.pro
