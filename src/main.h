...
static const int64 MAX_MONEY = 8800000000 * COIN; // maximum number of coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 720 / 250; // 720 Blocks found per day one for every 2 minutes in a 24 hour cycle
    }
