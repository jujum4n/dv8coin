...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("dv8coin://"))
    {
        uri.replace(0, 11, "dv8coin:");
    }
...
{
    return GetAutostartDir() / "dv8coin.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("dv8coin-qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  dv8coin-qt [" + tr("command-line options") + "]                     " + "\n";
